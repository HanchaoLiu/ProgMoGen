...
from visualize import vis_utils_v2
import shutil
...
if __name__ == '__main__':
    ...
    for sample_i in run_list:
        t0=time.time()
        out_npy_path = os.path.join(results_dir, f'gen{sample_i}_smpl_params.npy')
        print(sample_i, out_npy_path)
        npy2obj = vis_utils_v2.npy2obj(npy_path, sample_i, rep_i,
