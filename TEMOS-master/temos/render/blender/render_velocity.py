...
from .floor import show_traj, plot_floor, get_trajectory, plot_floor_for_velocity
...
def render_velocity(npydata, frames_folder, *, mode, faces_path, gt=False,
    ...
    # Create a floor
    plot_floor_for_velocity(data.data, big_plane=False)
