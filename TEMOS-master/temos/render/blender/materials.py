...
def body_material_transparent(r, g, b, a=1, name="body", oldrender=True):
    oldrender=False
    if oldrender:
        material = colored_material_diffuse_BSDF(r, g, b, a=a)
    else:
        ...
        inputs["Alpha"].default_value = 0.4

    return material



def body_material_transparent_with_alpha(r, g, b, a=1, alpha=0.4, name="body", oldrender=True):
    oldrender=False
    if oldrender:
        material = colored_material_diffuse_BSDF(r, g, b, a=a)
    else:
