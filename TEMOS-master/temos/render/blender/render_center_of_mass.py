...
from .floor import show_traj, plot_floor, get_trajectory, plot_floor_for_center_of_mass
...
def render_center_of_mass(npydata, frames_folder, *, mode, faces_path, gt=False,
    ...
    # stand on this cylinder
    show_cylinder()

    # Create a floor
    # plot_floor(data.data)
    plot_floor_for_center_of_mass(data.data, big_plane=False)
    ...
    # frameidx = [27,82,136,191] # do not use
    # frameidx = [82,136,191] # do not use
    # frameidx = [44,124,184] # this is good
    ...
    for index, frameidx in enumerate(frameidx):
        ...
        if mode == "sequence":
            ...
            if index==nframes_to_render-1:
                ...
                mat = data.get_sequence_mat_alpha(frac, alpha=(index+1)/(nframes_to_render))
