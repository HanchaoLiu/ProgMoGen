...
from .floor import show_traj, plot_floor, get_trajectory, plot_floor_for_head_hand_contact
...
def set_camera():
    ...
    camera.rotation_euler.z=55/180*3.14
    # camera.data.lens = 120

def render_head_hand_contact(npydata, frames_folder, *, mode, faces_path, gt=False,
    ...
    # Create a floor
    plot_floor_for_head_hand_contact(data.data, big_plane=False)
    ...
    # frameidx= [0, 17, 35, 52, 70, 87]
    # frameidx= [0, 17, 35, 52]
    # frameidx= [0, 8, 17, 29, 35, 43, 52]


    # 1115 
    use_1115_seq=False
    if use_1115_seq:
        frameidx= [0, 10, 20, 30, 40, 50]
