...
def render_cli(cfg: DictConfig) -> None:
    ...
    # from temos.render.blender import render_base_rawheight_massctr_trans
    from temos.render.blender import render_center_of_mass
    ...
    for path in paths:
        ...
        out = render_center_of_mass(data, frames_folder,
