...
def f_loss(self, sample, joints_pos_frame0):
    ...
    loss_head = loss_head_from_rot(sample, h0=self.h_gt_list[1], t=t_middle, frame0=joints_pos_frame0)*2 + \
...
# v2: skeleton template from file instead from running inference again.
# ddim_sample_loop_opt_head_height_ikrot_gt_v2
