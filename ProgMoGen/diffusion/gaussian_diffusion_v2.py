...
class GaussianDiffusion_v2:
    ...
    def __init__(
        ...
        *,
        ...
        print("mean_type=",self.model_mean_type)
    ...
    def p_mean_variance(
        ...
        # print("in p_mean_variance, self.model_mean_type=", self.model_mean_type)
        ...
        if self.model_mean_type == ModelMeanType.PREVIOUS_X:
            ...
            if self.model_mean_type == ModelMeanType.START_X:
                # print("use this process_xstart") this is used
                pred_xstart = process_xstart(model_output)
                # print("use this process_xstart")
            else:
                pred_xstart = process_xstart(
                    self._predict_xstart_from_eps(x_t=x, t=t, eps=model_output)
                )
            # weighted sum of pred_xstart and x_t, weighted.sum()!=1
            model_mean, _, _ = self.q_posterior_mean_variance(
                x_start=pred_xstart, x_t=x, t=t
            )
            # print(th.allclose(pred_xstart, model_output))
        else:
    ...
    def p_sample_loop(
        ...
        for i, sample in enumerate(self.p_sample_loop_progressive(
            ...
            res_list.append([sample["sample"], sample['noise']])
        ...
        print("noise_grad=", res_list[0][1].grad.shape)
    ...
    def p_sample_loop_progressive(
        ...
        if init_image is not None:
            ...
            if predict_two_person:
                ...
                # print('shape=',init_image.shape, my_t.shape, img.shape)
