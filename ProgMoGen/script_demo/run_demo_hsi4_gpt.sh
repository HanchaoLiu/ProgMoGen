...
${blender_app} --background --python render_demo_hsi4.py -- npy=${mesh_file} canonicalize=true mode="sequence"
${blender_app} --background --python render_demo_hsi4.py -- npy=${mesh_file} canonicalize=true mode="video"
