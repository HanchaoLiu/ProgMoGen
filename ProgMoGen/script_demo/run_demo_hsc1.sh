...
${blender_app} --background --python render_demo_hsc1.py -- npy=${mesh_file}  canonicalize=true mode="sequence"
${blender_app} --background --python render_demo_hsc1.py -- npy=${mesh_file}  canonicalize=true mode="video"
