...
def create_gaussian_diffusion(args, DiffusionClass=SpacedDiffusion):
    ...
    # print("in create_gaussian_diffusion args.use_ddim_tag=", args.use_ddim_tag)
    # sys.exit(0)
    if args.use_ddim_tag==0:
        timestep_respacing = '' 
    else:
        timestep_respacing = 'ddim100'  # can be used for ddim sampling, we don't use it.
        # timestep_respacing = 'ddim500'  # can be used for ddim sampling, we don't use it.
        print("using ddim100 in create_gaussian_diffusion")
