...
def calculate_diversity_with_idx(activation, diversity_times):
    assert len(activation.shape) == 2
    assert activation.shape[0] > diversity_times
    num_samples = activation.shape[0]
...
def calculate_diversity_with_idx_nocheck(activation, diversity_times):
    assert len(activation.shape) == 2
    # assert activation.shape[0] > diversity_times
    num_samples = activation.shape[0]
...
def calculate_diversity_with_idx_input(activation, first_indices, second_indices, diversity_times):
    assert len(activation.shape) == 2
    assert activation.shape[0] > diversity_times
    num_samples = activation.shape[0]
